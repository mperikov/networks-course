...
3. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   ...
   - Sequence Number (raw): 1258869609  
   - С помощью флага Syn
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - Sequence Number (raw): 3252678001
   - Acknowledgment number (raw): 1258869610
   - Sequence Number (raw) SYN TCP-сегмента клиента, увеличенный на один
   - С помощью флагов Syn и Acknowledgment
5. Какой порядковый номер у TCP-сегмента, содержащего команду POST протокола HTTP?
   ...
   Sequence Number (raw): 1258869610
   ![](images/image-8.png)
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   | Порядковый номер | Время отправки | Время получения ACK-пакета | RTT        |
   | ---------------- | -------------- | -------------------------- | ---------- |
   | 1                | 19.851771      | 20.010443                  | 158.672000 |
   | 634              | 19.851905      | 20.010443                  | 158.538000 |
   | 2094             | 19.851905      | 20.010443                  | 158.538000 |
   | 3554             | 19.851905      | 20.010443                  | 158.538000 |
   | 5014             | 19.851905      | 20.010443                  | 158.538000 |
   | 6474             | 19.851905      | 20.010443                  | 158.538000 |
...
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - **215689** байт/с.
   - Всего передано **152954** байта, разница между временем отправки последнего подтверждения и первого пакета равна
   **20.560914 - 19.851771 = 0.709143** секунд, итого **215689** байт/с.
